...
import { useAuthActionsAdmin } from '@/hooks/useAuthActionsAdmin';
...
export function AuthFormAdmin({ mode, loading }: AuthFormProps) {
  const { handleAuthSubmit } = useAuthActionsAdmin();
